...
<div class="container bg-success">
 <nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="index.php"><img style="width:220px;height:35px;" src="images/geeksbyteadmin.png"></a>
    </div>
 ...
 <div class="panel panel-primary">
     <div class="panel-heading"><h3 class="text-default"> <div class="text-center"><strong>Add Your Post </strong></div></h3></div>
...
<div class="form-group">
    <label>Chose Post Category:</label>
...
<option><?php echo $row['id'];?>  <?php echo $row['text'];?></option>
 <?php }} ?>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" name="contents" rows="8" id="textarea" placeholder="Write Here Post Content"></textarea>
  <div class="form-group">
...
if (isset($_POST["btn"])) {
  ...
  $date=$_POST["date"];
  include 'connect.php';
  $sql="insert into posts(category,title,content,author,tags,date) values('".$category."','".$title."','".$content."','".$author."','".$tags."','".$date."')";
